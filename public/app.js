...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = function (_Component) {
	  ...
	  _createClass(Counter, [{
	    ...
	    value: function render() {
	      ...
	      var showdiv = _props.showdiv;
	      var show_bool = _props.show_bool;
	      //渲染组件，包括一个数字，四个按钮
	...
	Counter.propTypes = {
	  ...
	  showdiv: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports) {
	...
	var SHOW_BOOL = exports.SHOW_BOOL = 'SHOW_BOOL';
	//导出加一的方法
	function increment() {
	  return {
	...
	function incrementIfOdd() {
	  return function (dispatch, getState) {
	    ...
	    var counter = states.counterObj.counter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(initialState) {
	  var store = createStoreWithMiddleware(_reducers2.default, initialState, window.devToolsExtension ? window.devToolsExtension() : undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rootReducer = (0, _redux.combineReducers)({
	  counter: _counter2.default.counter,
	  show_bool: _counter2.default.show_bool
	});
	...
	function counter() {
	  ...
	  switch (action.type) {
	    ...
	    case _counter.DECREMENT_COUNTER:
	      return state.counter - 1;
	    case _counter.SHOW_BOOL:
	      state.show_bool = !state.show_bool;
	      return state.show_bool;
	    default:
	      return state;
	  }
	}
