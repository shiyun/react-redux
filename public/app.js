...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageItem = function (_Component) {
		...
		function MessageItem(props) {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(MessageItem).call(this, props));
		}
		...
		_createClass(MessageList, [{
			...
			value: function render() {
				var msgItems = this.props.messages.map(function (value, index) {
					return _react2.default.createElement(MessageItem, { key: index, message: index + " " + value });
				}, this);
	...
	var messages = ["Hello world!", "Goodbye y'all!", "Is it dinner yet?", "Cats are fun!", "But dogs are funner"];

	_reactDom2.default.render(_react2.default.createElement(MessageList, { messages: messages }), document.getElementById('app'));
